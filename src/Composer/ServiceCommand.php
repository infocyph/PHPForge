...
final class ServiceCommand extends Command
{
    ...
    private function serviceEnvironment(array $services, array $topologies): array
    {
        ...
        return [
            ...
            'IC_MSSQL_PRIMARY_DSN' => "sqlsrv:Server=127.0.0.1,1433;Database={$database};TrustServerCertificate=1",
            'IC_MSSQL_REPLICA_DSN' => "sqlsrv:Server=127.0.0.1,1434;Database={$database};TrustServerCertificate=1",
            'IC_MSSQL_USER' => 'sa',
            ...
            'IC_REDIS_PORT' => '6379',
            'IC_REDIS_REPLICA_HOST' => '127.0.0.1',
            'IC_REDIS_REPLICA_PORT' => '6381',
            'IC_REDIS_PASSWORD' => $password,
            'IC_VALKEY_HOST' => '127.0.0.1',
            'IC_VALKEY_PORT' => '6380',
            'IC_VALKEY_REPLICA_HOST' => '127.0.0.1',
            'IC_VALKEY_REPLICA_PORT' => '6382',
            ...
            'IC_RABBITMQ_CLUSTER_NODES' => '127.0.0.1:5672,127.0.0.1:5673,127.0.0.1:5674',
            'IC_NATS_URL' => 'nats://127.0.0.1:4222',
            'IC_NATS_MONITOR_URL' => 'http://127.0.0.1:8222',
            'IC_NATS_CLUSTER_URLS' => 'nats://127.0.0.1:4222,nats://127.0.0.1:4223,nats://127.0.0.1:4224',
            ...
            'IC_ELASTICSEARCH_CLUSTER_URLS' => 'http://127.0.0.1:9200,http://127.0.0.1:9201',
            'IC_SCYLLADB_HOST' => '127.0.0.1',
            'IC_SCYLLADB_PORT' => '8000',
            'IC_SCYLLADB_ENDPOINT' => 'http://127.0.0.1:8000',
            'IC_SCYLLADB_ADMIN_URL' => 'http://127.0.0.1:10000',
            'IC_SCYLLADB_CLUSTER_ENDPOINTS' => 'http://127.0.0.1:8000,http://127.0.0.1:8001,http://127.0.0.1:8002',
