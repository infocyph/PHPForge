...
final class CommandProvider implements CommandProviderCapability
{
    public function getCommands(): array
    {
        return [
            ...
            new CleanCommand(),
            new VersionCommand(),
            new InfocyphCommand('ic:process', 'Run Rector, Pint, and PHPCBF fixes.', TaskCatalog::processAll()),
            new InfocyphCommand('ic:process:all', 'Run Rector, Pint, and PHPCBF fixes.', TaskCatalog::processAll()),
